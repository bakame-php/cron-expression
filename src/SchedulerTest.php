...
final class SchedulerTest extends TestCase
{
    ...
    public function testIsDueHandlesDifferentTimezones(): void
    {
        ...
        $cronUTC = new Scheduler($cron, 'UTC', DatePresence::EXCLUDED); //Wednesday at 15:00
        $cronAms = new Scheduler($cron, 'Europe/Amsterdam', DatePresence::EXCLUDED); //Wednesday at 15:00
        $cronTok = new Scheduler($cron, new DateTimeZone('Asia/Tokyo'), DatePresence::EXCLUDED); //Wednesday at 15:00
    ...
    public function testIsDueHandlesDifferentTimezonesAsArgument(): void
    {
        ...
        $cronUTC = new Scheduler($cron, 'UTC', DatePresence::EXCLUDED); //Wednesday at 15:00
        $cronAms = new Scheduler($cron, new DateTimeZone('Europe/Amsterdam'), DatePresence::EXCLUDED); //Wednesday at 15:00
        $cronTok = new Scheduler($cron, new DateTimeZone('Asia/Tokyo'), DatePresence::EXCLUDED); //Wednesday at 15:00
        $date = '2014-01-01 15:00'; //Wednesday
        $utc = new DateTimeZone('UTC');
        $amsterdam = new DateTimeZone('Europe/Amsterdam');
    ...
    public function testItFailsWithAWrongTimezone(): void
    {
        ...
        new Scheduler('* * * * *', 'Foo/Bar', DatePresence::EXCLUDED);
    }
    ...
    public function testRecognisesTimezonesAsPartOfDateTime(): void
    {
        ...
        $scheduler = new Scheduler(expression: '0 7 * * *', timezone: $tzCron, initialDatePresence: DatePresence::EXCLUDED);
    ...
    {
        $initial = new Scheduler('0 7 * * *', 'Africa/Nairobi', DatePresence::EXCLUDED);
    ...
    {
        $scheduler = new Scheduler('0 7 * * *', 'Africa/Nairobi', DatePresence::EXCLUDED);
    ...
    public function testRunReturnsADateTimeImmutableObject(): void
    {
        ...
        $scheduler = new Scheduler('0 15 2 * 3', 'Africa/Kampala', DatePresence::EXCLUDED);
    ...
    public function testDSTFixForDateIntervalUpdates(): void
    {
        ...
        $scheduler = new Scheduler('0 1 * * 0', $tz, DatePresence::INCLUDED);
